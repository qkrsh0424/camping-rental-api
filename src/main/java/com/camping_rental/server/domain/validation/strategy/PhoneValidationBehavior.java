...
public class PhoneValidationBehavior {
    ...
    @RequiredArgsConstructor
    @Component
    public static class Modify implements PhoneValidaitonStrategy{
        private final UserService userService;
        private final TwilioSmsService twilioSmsService;

        @Override
        public PhoneValidationName getStrategyName() {
            return PhoneValidationName.ForModify;
        }
    ...
    @RequiredArgsConstructor
    @Component
    public static class RentalOrder implements PhoneValidaitonStrategy{
        private final UserService userService;
        private final TwilioSmsService twilioSmsService;

        @Override
        public PhoneValidationName getStrategyName() {
            return PhoneValidationName.ForRentalOrder;
        }
